          ...
          <div className="flex flex-col items-center py-6 lg:h-[36rem] lg:flex-row">
            <div className="lg:w-1/2">
              ...
              <p className="mt-4 text-gray-100">
                A smart platform to manage library operations seamlessly —
                including book check-ins/outs, user memberships, and real-time
                tracking of library resources. Designed for efficiency,
